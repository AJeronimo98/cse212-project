...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found:
    // No defects found after correcting queue repetition behavior.
    ...
    // Defect(s) Found:
    // Queue ordering needed to preserve FIFO behavior after re-adding players.
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:
    // Players with 0 turns (infinite turns) were not being re-added to the queue.
    ...
    // Defect(s) Found:
    // Players with negative turns (infinite turns) were not being re-added to the queue.
    ...
    // Defect(s) Found:
    // No defects found. Exception handling works correctly.
